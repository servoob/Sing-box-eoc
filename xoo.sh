...
USERNAME=$(whoami)
HOSTNAME=$(hostname)
export UUID=${UUID:-'8e3267f4-e2eb-c25f-1536-e16569bbc54b'}
...
vless://${UUID}@${SERVER_IP}:${VLESS_PORT}?encryption=none&flow=xtls-rprx-vision&security=reality&sni=itunes.apple.com&fp=chrome&pbk=${public_key}&type=tcp&headerType=none#${isp}
